...
export const neonContractABI = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: "address", name: "_depositTokenAddress", type: "address" },
  ...
  },
  {
    inputs: [
      { internalType: "uint256", name: "_amount", type: "uint256" },
      { internalType: "address", name: "_borrowTokenAddress", type: "address" },
    ],
    name: "borrow",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    ...
    outputs: [{ internalType: "contract PositionToken", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
